...
local PAL = {
  ...
  -- the cartridge-colour version rail is the one piece of brand colour that stays
  railRed     = { 255, 60, 72 },
  railBlue    = { 70, 150, 255 },
  railGold    = { 255, 203, 5 },
  railCrystal = { 72, 224, 220 },
}
...
-- The 4px cartridge-colour rail across the top of both windows.
function Theme.versionRail(x, y, w, h)
  if not G then return end
  local bars = { PAL.railRed, PAL.railBlue, PAL.railGold, PAL.railCrystal }
  local seg = w / #bars
