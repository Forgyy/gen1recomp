...
function Cartridge.new(modules)
  ...
  cartridge.get_rtc_state = function()
    local mapper = cartridge.active_mbc
    return mapper and mapper.get_rtc_state and mapper:get_rtc_state() or nil
  end

  cartridge.load_rtc_state = function(state)
    local mapper = cartridge.active_mbc
    return mapper and mapper.load_rtc_state and mapper:load_rtc_state(state) or false
  end
